class InventariosController < ApplicationController
  ...
  def index
    ...
    @inventarios = Inventario.paginate(:page => params[:page])
  end
  ...
  private
    ...
    def inventario_params
      params.require(:inventario).permit(:ln, :part, :site, :site_desc, :loc, :lot, :ref, :loc_des, :create, :expire, :qty_oh, :qty_all, :status)
    end
end
